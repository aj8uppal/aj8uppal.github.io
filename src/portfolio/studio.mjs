...
export default function render() {
  ...
  <section class="st-work" id="work" aria-labelledby="st-work-title"><div class="st-section-heading"><div><p class="st-label">The things I learn by making</p><h2 id="st-work-title">Off the workbench</h2></div><p>${shelf.length} selected projects.<br>The engineering behind the play.</p></div><div class="st-grid">${shelf.map(card).join('')}</div><div class="st-in-progress"><span class="st-label">Also on the desk</span><p>Two experiments still finding their shape.</p><div>${caseLink('hidamari', 'hidamari · in progress', 'st-link')}${caseLink('elderwood', 'Elderwood Vale · in progress', 'st-link')}</div></div></section>
  ${collectionDoor(['slipstream', 'eyeshot', 'beatlayer'])}
