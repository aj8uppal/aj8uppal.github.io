...
<section class="ob-work" id="projects" aria-labelledby="ob-projects-title"><header class="ob-section-heading"><div><p class="ob-label">Personal work / ${String(homeProjectKeys.length).padStart(2, '0')} selected projects</p><h2 id="ob-projects-title">Questions worth<br><em>building around.</em></h2></div><p>A few places my curiosity has led.<br>Open a project, or follow the decisions that made it work.</p></header><div class="ob-projects">${homeProjectKeys.map(card).join('')}</div></section>
