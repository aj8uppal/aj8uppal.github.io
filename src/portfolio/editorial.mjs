...
export default function render() {
  return frame(
    ...
    <header class="ed-nav"><a class="ed-brand" href="#top">AJ Uppal<span>.</span></a><nav aria-label="Main navigation"><a href="#work">Work</a><a href="/portfolio/collection/">Collection</a><a href="#about">About</a>${email('Say hello')}</nav></header>
    <main id="main">
      ...
      <section class="ed-work" id="work" aria-labelledby="ed-work-title"><div class="ed-section-line"><h2 id="ed-work-title">Selected work</h2><span class="ed-label">${leadProjects.length + shortProjects.length} projects / a few ways I think</span></div>${leadProjects.map(lead).join('')}
