...
export const blockhold = {
  ...
  sub: 'Voxel tower defense. Ten maps, 249 authored waves, and three boards that each break a rule the other nine keep.',
  skim: {
    role: 'All of it: the voxel modeler, the fixed-step sim, ten maps, 249 waves, the balance.',
    hard: 'Shipping a game this size with almost nothing to download. Every model is colored boxes placed in code, every sound is synthesized the moment it plays, every icon is a hand-drawn SVG.',
    proof:
      'Playable right now: ten maps, three difficulties, three heroes, an endless mode with saved records.',
  },
  spread: {
    n: 'Plate 06 / Blockhold',
    t: 'The one that shipped',
    s: 'Greenhollow’s last wave walking into the line, the Hollow King somewhere in it.',
  },
  framesLede: 'Four of the ten boards.',
  framesCue: 'Click a tab, or use the arrow keys',
  prose: [
  ...
  plate: [
    ['Status', 'Live, installable, saves locally'],
    ['Campaign', 'Ten maps · 249 authored waves · up to five roads'],
    ['Towers', '4 families · 3 tiers · 2 elite branches · 2 branch-locked crowns'],
    ['Heroes', 'Three, with A* move orders'],
    ['Meta', 'Royal Armory: 8 star-funded tracks, free respec'],
    ['Endless', '200 waves per map, deepest-wave record'],
    ['Assets', 'None in 3D. Models are code, audio is synthesized, icons are SVG'],
    ['Sim', 'Fixed 60 Hz tick behind an accumulator'],
    ['Tests', '154, vitest'],
    ['Review', 'Six adversarial code rounds, then a three-round design review'],
  ] as Array<[string, string]>,
  figures: [
    {
      key: 'greenhollow',
      tab: 'Greenhollow',
      cap: 'The first board entire: one road, thirteen plots, and the meadow you learn the trade on.',
    },
    {
      key: 'veiltide',
      tab: 'Veiltide surge',
      cap: 'Frostmere Pass under a surge: empowered waves, violet sky, both frozen roads engaged.',
    },
    {
      key: 'cinderwake',
      tab: 'Cinderwake',
      cap: 'Cinderwake Caldera: three roads through the glassfire, lava where a plot could have been.',
    },
    {
      key: 'tidereach',
      tab: 'Tidereach',
      cap: 'Tidereach Causeway, the widest board in the game: five roads, and a tide that closes them.',
    },
  ],
} as const;
...
export const playground = {
  ...
  prose: ['All three run here in the page, on their original code. Go ahead.'],
  items: [
    {
      yr: 'c. 2019',
      name: 'AutoTyper',
